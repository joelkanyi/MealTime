 ...
 */
package com.kanyideveloper.core.analytics

import com.mixpanel.android.mpmetrics.MixpanelAPI
import org.json.JSONObject

class AnalyticsUtil(private val mixpanelAPI: MixpanelAPI) {
    ...
    fun setUserProfile(userID: String, userProperties: JSONObject? = null) {
        userProperties
            ?.let {
